...
- Local inference: [Ollama](https://github.com/jmorrice/ollama)
...
Optional: choose models via `TOGETHER_CHAT_MODEL`, `TOGETING_EMBEDDING_MODEL`. The embedding model's
...
or as a cron job. See this as a last resort, as there are gentler ways to stop above.
...
We support using [Ollama](https://github.com/jmorrice/ollama) for conversation generations. To have
